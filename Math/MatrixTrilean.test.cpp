/// clear && gcc -o ./Math/MatrixTrilean.out ./Math/MatrixTrilean.test.cpp -lstdc++ && echo "9 8 7 6 5 4 3 2 1" | ./Math/MatrixTrilean.out | tee ./Math/MatrixTrilean.test.out && rm ./Math/MatrixTrilean.out

#include "../Types/Trilean.hpp"
#include "../Types/Trilean.iostream.hpp"
#include "Matrix.hpp"
